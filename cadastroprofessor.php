...
<head>
    ...
    <title>Cadastro Professor | Portal Escolar</title>
</head>
<body>
    <div class="">
                ...
                <div class="col-3 d-flex px-md-5 py-md-2 align-items-center">
                    ...
                    <div>
                        <h1>Cadastro Professor</h1>
                            ...
                            <div>
                                <div class="mb-3">
                                    <label for="nomeAluno" class="form-label">Nome do Professor</label>
                            ...
                            <div>
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" id="disciplina" name="disciplina" placeholder="Disciplina Lecionada" aria-label="Campo para Disciplina lecionada">
                                    
                                </div>
                            </div>
                            <div>
                            <div class="mb-3">
                                    <label for="Digite a Formação do Professor" class="form-label">Formação</label>
                                    <input class="form-control" type="text" id="formacao" name="formacao" placeholder="Formação Professor" aria-label="Campo para Formação do Professor">
